...
inline UFX16_16 ufloatToFixed(float f)
{
    return (uint32_t)(f * (float)(1 << POST_DP_BITS) + (f >= 0 ? 0.5 : -0.5));
}

inline float ufixedToFloat(UFX16_16 f)
{
    return (float)f / (float)(1 << POST_DP_BITS);
}

inline UFX16_16 uintToUfixed(unsigned int a)
{
    return a << 16;
}
...
inline UFX16_16 uFXMul(UFX16_16 a, UFX16_16 b)
{
    return ((uint64_t)a * (uint64_t)b) >> POST_DP_BITS;
}

inline UFX16_16 uFXDiv(UFX16_16 a, UFX16_16 b)
{
...
///Signed fixed point
inline SFX16_16 sfloatToFixed(float f)
{
    return (int32_t)(f * (float)(1 << POST_DP_BITS) + (f >= 0 ? 0.5 : -0.5));
}

inline float sfixedToFloat(SFX16_16 f)
{
    return (float)f / (float)(1 << POST_DP_BITS);
}

inline SFX16_16 sintToSfixed(int a)
{
    return a << 16;
}

inline int sFixedToSint(SFX16_16 a)
{
    return a >> 16;
}
...
inline SFX16_16 sFXDiv(SFX16_16 a, SFX16_16 b)
{
    if(!a)
        return 0;
    if(b == 0)
